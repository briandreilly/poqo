import type { ProofSelection, RequestAnalysis } from "../types.js";
...
function buildWorldBasis(input: string): string[] {
  const basis: string[] = [];
...
export function selectProof(analysis: RequestAnalysis): ProofSelection {
