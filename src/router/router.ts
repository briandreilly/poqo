import type { RequestAnalysis, RoutingDecision } from "../types.js";

function buildNarrowExplanation(analysis: RequestAnalysis): string {
...
function buildProveExplanation(analysis: RequestAnalysis): string {
...
function buildDirectExplanation(analysis: RequestAnalysis): string {
...
export function routeJudgment(analysis: RequestAnalysis): RoutingDecision {
