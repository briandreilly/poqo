...
export function detectDomainAnchor(input) {
...
export function supportsCarriedDomainAnchor(input, carriedAnchor) {
    if (!carriedAnchor) {
        return false;
    }
    const normalized = normalize(input);
...
export function resolveDomainAnchor(input, contextAnchor = null) {
